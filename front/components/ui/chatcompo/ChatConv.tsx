...
function ChatConv(oldeId: any) {
  ...
  const fetchrol = async () => {
    try {
      const response = await axios.get(
        process.env.BACK_END_URL + "chat/settings/role",
        {
      ...
      //ror("An error occurred while fetching member data:", error);
    }
  };
  ...
  const fetchownerimage = async () => {
    try {
      const response = await axios.get(
        process.env.BACK_END_URL + "chat/settings/staff",
        {
          withCredentials: true,
          params: {
            id: id,
  ...
  const fetchRoomData = async () => {
    try {
      const response = await axios.get(
        process.env.BACK_END_URL + "chat/conversations/members",
        {
          withCredentials: true,
          params: {
            id: id,
  ...
  const fetchmemberdata = async () => {
    try {
      const response = await axios.get(
        process.env.BACK_END_URL + "chat/settings/members",
        {
          withCredentials: true,
          params: {
            id: id,
  ...
  const fetchMuteAndAdmine = async () => {
    try {
      const response = await axios.get(
        process.env.BACK_END_URL + "chat/settings/members/infos",
        {
          withCredentials: true,
          params: {
            id: id,
    ...
    const sendmute = async () => {
      try {
        ...
        const response = await axios.post(
          process.env.BACK_END_URL + "chat/settings/mute",
          {
            roomId: id,
            userId: data.id,
          },
...
const postkick = () => {
  const sendkick = async () => {
    try {
      ...
      const response = await axios.post(
        process.env.BACK_END_URL + "chat/settings/kick",
        {
          roomId: id,
          userId: data.id,
        },
...
const postban = () => {
  const sendban = async () => {
    try {
      const response = await axios.post(
        process.env.BACK_END_URL + "chat/settings/ban",
        {
          id,
          userId: data?.id,
        },
...
const postadmine = () => {
  const sendadmine = async () => {
    ...
    try {
      const response = await axios.post(
        process.env.BACK_END_URL + "chat/settings/add/admin",
        {
          roomId: id,
          userId: data.id,
        },
...
const posleave = () => {
  ...
  const sendleave = async () => {
    try {
      const response = await axios.post(
        process.env.BACK_END_URL + "chat/settings/leave",
        {
          roomId: id,
        },
        {
...
const send_data = async () => {
  try {
    const response = await axios.post(
      process.env.BACK_END_URL + "chat/settings/add/member",
      {
        roomId: id,
        userName: frdName,
      },
...
const sendNewPassword = async () => {
  try {
    const response = await axios.post(
      process.env.BACK_END_URL + "chat/settings/update",
      {
        roomId: id,
...
const deleatPassword = async () => {
  try {
    const response = await axios.post(
      process.env.BACK_END_URL + "chat/settings/delete",
      {
        roomId: id,
      },
      {
